...
#define EWOULDBLOCK   EAGAIN /* Same as EAGAIN on Linux */

#elif JACL_OS_DARWIN || JACL_OS_BSD

/* BSD/macOS errno values - different from Linux! */
#define EPERM           1    /* Operation not permitted */
#define ENOENT          2    /* No such file or directory */
#define ESRCH           3    /* No such process */
#define EINTR           4    /* Interrupted system call */
...
#define EWOULDBLOCK    35    /* Operation would block (same as EAGAIN) */
...
#define ENOLINK        97    /* ENOLINK (Reserved) */
...
/* Windows errno values - subset, different from POSIX */
#define EPERM           1    /* Operation not permitted */
#define ENOENT          2    /* No such file or directory */
#define ESRCH           3    /* No such process */
...
#define EHOSTUNREACH   110   /* Host unreachable */
#define EIDRM          111   /* Identifier removed */
#define EINPROGRESS    112   /* Operation in progress */
#define EISCONN        113   /* Already connected */
#define ELOOP          114   /* Too many symbolic link levels */
#define EMSGSIZE       115   /* Message too large */
#define ENETDOWN       116   /* Network down */
#define ENETRESET      117   /* Network reset */
#define ENETUNREACH    118   /* Network unreachable */
#define ENOBUFS        119   /* No buffer space */
#define ENODATA        120   /* No message available */
#define ENOLINK        121   /* No link */
#define ENOMSG         122   /* No message */
#define ENOPROTOOPT    123   /* No protocol option */
#define ENOSR          124   /* No stream resources */
#define ENOSTR         125   /* Not a stream */
#define ENOTCONN       126   /* Not connected */
#define ENOTRECOVERABLE 127  /* State not recoverable */
#define ENOTSOCK       128   /* Not a socket */
#define ENOTSUP        129   /* Not supported */
#define EOPNOTSUPP     130   /* Operation not supported */
#define EOTHER         131   /* Other */
#define EOVERFLOW      132   /* Value too large */
#define EOWNERDEAD     133   /* Owner dead */
#define EPROTO         134   /* Protocol error */
#define EPROTONOSUPPORT 135  /* Protocol not supported */
#define EPROTOTYPE     136   /* Wrong protocol type */
#define ETIME          137   /* Timer expired */
#define ETIMEDOUT      138   /* Timed out */
#define ETXTBSY        139   /* Text file busy */
#define EWOULDBLOCK    140   /* Operation would block */

#elif JACL_ARCH_WASM || JACL_OS_JSRUN || JACL_OS_WASI

/* WASM/JSRUN/WASI errno values - use Linux-compatible values */
#define EPERM           1    /* Operation not permitted */
#define ENOENT          2    /* No such file or directory */
#define ESRCH           3    /* No such process */
#define EINTR           4    /* Interrupted system call */
